...
/// {{Notranslate}} Hue value for all logic blocks.
Blockly.Msg.LOGIC_HUE = '#ff5722';
/// {{Notranslate}} Hue value for all loop blocks.
Blockly.Msg.LOOPS_HUE = '#311b92';
/// {{Notranslate}} Hue value for all math blocks.
Blockly.Msg.MATH_HUE = '#2e7d32';
/// {{Notranslate}} Hue value for all text blocks.
Blockly.Msg.TEXTS_HUE = '#ff9800';
/// {{Notranslate}} Hue value for all list blocks.
Blockly.Msg.LISTS_HUE = '#f44336';
/// {{Notranslate}} Hue value for all colour blocks.
Blockly.Msg.COLOUR_HUE = '#03a9f4';
/// {{Notranslate}} Hue value for all variable blocks.
Blockly.Msg.VARIABLES_HUE = '#f48fb1';
/// {{Notranslate}} Hue value for all variable dynamic blocks.
Blockly.Msg.VARIABLES_DYNAMIC_HUE = '310';
/// {{Notranslate}} Hue value for all procedure blocks.
Blockly.Msg.PROCEDURES_HUE = '#039be5';
/// {{Notranslate}} Hue value for all ROS basic blocks.
Blockly.Msg.ROS_BASIC_HUE = '#ce93d8';
/// {{Notranslate}} Hue value for all ROS mobile robot blocks.
Blockly.Msg.ROS_MESSAGE_HUE = '#7e57c2';
/// {{Notranslate}} Hue value for all ROS messages blocks.
Blockly.Msg.ROS_MOBILE_HUE = '#e91e63';
/// {{Notranslate}} Hue value for all ROS robot selection blocks.
Blockly.Msg.ROS_ROBOT_HUE = '#e53935';
